...
(
    'putting social science to the test: mixed-methods \
    approaches to lahore’s developmental challenges',
    4
),
...
(
    'trauma-informed education systems: creating cultures of \
    support and change',
    2
),
...
(
    'designing immersive learning experiences: student-centered \
...
(
    'rethinking the politics of harem in literature: women, islam, \
    and gendered spaces',
    2
),
(
...
(
    'symmetry methods, conservation laws and exact \
