...
final degreeCourseProvider = FutureProvider.family<List<Course>, Int64>((
  ref,
  id,
) async {
...
class DegreeCourseScreen extends ConsumerWidget {
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    final coursesAsync = ref.watch(degreeCourseProvider(id));
      ...
      child: Column(
        children: [
          ...
          coursesAsync.when(
            ...
            error: (e, st) =>
                Text('Error loading courses of degree type $id: $e'),
            data: (courses) {
              if (courses.isEmpty) {
                return const Center(
                  child: Text("No courses for this degree were found."),
                );
              }
