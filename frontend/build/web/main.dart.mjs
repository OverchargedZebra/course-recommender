...
class CompiledApp {
  ...
  async instantiate(additionalImports, {loadDeferredWasm, loadDynamicModule} = {}) {
    ...
    const dart2wasm = {
      ...
      _1294: () => globalThis.removeSplashFromWeb(),
      _1298: Date.now,
      ...
      _1438: x0 => x0.abort(),
      _1439: (x0,x1,x2,x3,x4,x5) => x0.open(x1,x2,x3,x4,x5),
      _1440: (x0,x1) => x0.overrideMimeType(x1),
      _1441: (x0,x1,x2) => x0.setRequestHeader(x1,x2),
      _1442: (x0,x1) => x0.send(x1),
      _1443: () => new XMLHttpRequest(),
      _1449: f => finalizeWrapper(f, function(x0) { return dartInstance.exports._1449(f,arguments.length,x0) }),
      _1451: (x0,x1,x2,x3) => x0.addEventListener(x1,x2,x3),
      _1452: (x0,x1,x2,x3) => x0.removeEventListener(x1,x2,x3),
      _1458: (x0,x1) => x0.key(x1),
      _1468: x0 => x0.getAllResponseHeaders(),
      _1469: (s, m) => {
        try {
      ...
      _1635: x0 => x0.readyState,
      _1642: x0 => x0.status,
      _1645: (x0,x1) => { x0.responseType = x1 },
      _1647: x0 => x0.responseText,
      _3429: () => globalThis.window,
      _3756: x0 => x0.localStorage,
      _4089: x0 => x0.length,
