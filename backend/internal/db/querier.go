...
type Querier interface {
	...
	ListCourseTags(ctx context.Context) ([]CourseTag, error)
	ListCourses(ctx context.Context) ([]Course, error)
	ListDegreeCourses(ctx context.Context) ([]DegreeCourse, error)
	ListDegreeTypes(ctx context.Context) ([]DegreeType, error)
	ListStudentCourseByStudentId(ctx context.Context, studentID int64) ([]StudentCourse, error)
	ListStudentCourses(ctx context.Context) ([]StudentCourse, error)
