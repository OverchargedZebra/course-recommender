...
type Querier interface {
	...
	GetCourseByName(ctx context.Context, courseName pgtype.Text) ([]Course, error)
	...
	GetDegreeTypeByName(ctx context.Context, degreeName pgtype.Text) ([]DegreeType, error)
	...
	GetStudentByEmail(ctx context.Context, studentEmail string) (Student, error)
	GetStudentsByCourseId(ctx context.Context, id int64) ([]GetStudentsByCourseIdRow, error)
	GetTag(ctx context.Context, id int64) (Tag, error)
	GetTagByName(ctx context.Context, tagName pgtype.Text) ([]Tag, error)
