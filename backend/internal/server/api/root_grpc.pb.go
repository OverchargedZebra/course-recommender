...
const (
	...
	CourseRecommenderService_GetStudentByEmail_FullMethodName            = "/course_recommender.CourseRecommenderService/GetStudentByEmail"
...
type CourseRecommenderServiceClient interface {
	...
	GetStudentByEmail(ctx context.Context, in *GetStudentByEmailRequest, opts ...grpc.CallOption) (*GetStudentByEmailResponse, error)
...
func (c *courseRecommenderServiceClient) GetStudentByEmail(ctx context.Context, in *GetStudentByEmailRequest, opts ...grpc.CallOption) (*GetStudentByEmailResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(GetStudentByEmailResponse)
	err := c.cc.Invoke(ctx, CourseRecommenderService_GetStudentByEmail_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type CourseRecommenderServiceServer interface {
	...
	// Retrieves a student by their email.
	GetStudentByEmail(context.Context, *GetStudentByEmailRequest) (*GetStudentByEmailResponse, error)
	// Updates an existing student's information.
...
func (UnimplementedCourseRecommenderServiceServer) GetStudentByEmail(context.Context, *GetStudentByEmailRequest) (*GetStudentByEmailResponse, error) {
...
func _CourseRecommenderService_GetStudentByEmail_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(GetStudentByEmailRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(CourseRecommenderServiceServer).GetStudentByEmail(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: CourseRecommenderService_GetStudentByEmail_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(CourseRecommenderServiceServer).GetStudentByEmail(ctx, req.(*GetStudentByEmailRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var CourseRecommenderService_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		},
		{
			...
			Handler:    _CourseRecommenderService_GetStudentByEmail_Handler,
		},
		{
