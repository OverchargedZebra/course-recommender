...
type Student struct {
	...
	StudentPassword string                 `protobuf:"bytes,3,opt,name=student_password,json=studentPassword,proto3" json:"student_password,omitempty"` // In a real-world app, this would likely be a hashed password.
...
func (x *Student) GetStudentEmail() string {
	if x != nil {
...
func (x *Student) GetStudentPassword() string {
	if x != nil {
...
type CreateStudentRequest struct {
	state           protoimpl.MessageState `protogen:"open.v1"`
	StudentEmail    string                 `protobuf:"bytes,1,opt,name=student_email,json=studentEmail,proto3" json:"student_email,omitempty"`
...
func (x *CreateStudentRequest) GetStudentEmail() string {
	if x != nil {
		return x.StudentEmail
	}
	return ""
...
type GetStudentByEmailRequest struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	StudentEmail  string                 `protobuf:"bytes,1,opt,name=student_email,json=studentEmail,proto3" json:"student_email,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
...
func (x *GetStudentByEmailRequest) Reset() {
	*x = GetStudentByEmailRequest{}
	mi := &file_student_proto_msgTypes[5]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}

func (x *GetStudentByEmailRequest) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*GetStudentByEmailRequest) ProtoMessage() {}

func (x *GetStudentByEmailRequest) ProtoReflect() protoreflect.Message {
	mi := &file_student_proto_msgTypes[5]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use GetStudentByEmailRequest.ProtoReflect.Descriptor instead.
func (*GetStudentByEmailRequest) Descriptor() ([]byte, []int) {
	return file_student_proto_rawDescGZIP(), []int{5}
}

func (x *GetStudentByEmailRequest) GetStudentEmail() string {
	if x != nil {
		return x.StudentEmail
	}
	return ""
...
// Response containing the requested student.
type GetStudentByEmailResponse struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	Student       *Student               `protobuf:"bytes,1,opt,name=student,proto3" json:"student,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
...
func (x *GetStudentByEmailResponse) Reset() {
	*x = GetStudentByEmailResponse{}
	mi := &file_student_proto_msgTypes[6]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}

func (x *GetStudentByEmailResponse) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*GetStudentByEmailResponse) ProtoMessage() {}

func (x *GetStudentByEmailResponse) ProtoReflect() protoreflect.Message {
	mi := &file_student_proto_msgTypes[6]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use GetStudentByEmailResponse.ProtoReflect.Descriptor instead.
func (*GetStudentByEmailResponse) Descriptor() ([]byte, []int) {
	return file_student_proto_rawDescGZIP(), []int{6}
}

func (x *GetStudentByEmailResponse) GetStudent() *Student {
	if x != nil {
		return x.Student
	}
	return nil
...
type UpdateStudentRequest struct {
	state           protoimpl.MessageState  `protogen:"open.v1"`
	Id              int64                   `protobuf:"varint,1,opt,name=id,proto3" json:"id,omitempty"`
	StudentEmail    *wrapperspb.StringValue `protobuf:"bytes,2,opt,name=student_email,json=studentEmail,proto3" json:"student_email,omitempty"`
...
func (x *UpdateStudentRequest) GetStudentEmail() *wrapperspb.StringValue {
	if x != nil {
		return x.StudentEmail
	}
	return nil
...
const file_student_proto_rawDesc = "" +
	"\n" +
	"\rstudent.proto\x12\x12course_recommender\x1a\x1egoogle/protobuf/wrappers.proto\"i\n" +
	"\aStudent\x12\x0e\n" +
	"\x02id\x18\x01 \x01(\x03R\x02id\x12#\n" +
	"\rstudent_email\x18\x02 \x01(\tR\fstudentEmail\x12)\n" +
	"\x10student_password\x18\x03 \x01(\tR\x0fstudentPassword\"f\n" +
	"\x14CreateStudentRequest\x12#\n" +
	"\rstudent_email\x18\x01 \x01(\tR\fstudentEmail\x12)\n" +
	...
	"\astudent\x18\x01 \x01(\v2\x1b.course_recommender.StudentR\astudent\"?\n" +
	"\x18GetStudentByEmailRequest\x12#\n" +
	"\rstudent_email\x18\x01 \x01(\tR\fstudentEmail\"R\n" +
	"\x19GetStudentByEmailResponse\x125\n" +
	"\astudent\x18\x01 \x01(\v2\x1b.course_recommender.StudentR\astudent\"\xb2\x01\n" +
	"\x14UpdateStudentRequest\x12\x0e\n" +
	"\x02id\x18\x01 \x01(\x03R\x02id\x12A\n" +
	"\rstudent_email\x18\x02 \x01(\v2\x1c.google.protobuf.StringValueR\fstudentEmail\x12G\n" +
...
var file_student_proto_goTypes = []any{
	...
	(*GetStudentByEmailRequest)(nil),  // 5: course_recommender.GetStudentByEmailRequest
	(*GetStudentByEmailResponse)(nil), // 6: course_recommender.GetStudentByEmailResponse
...
var file_student_proto_depIdxs = []int32{
	...
	0,  // 2: course_recommender.GetStudentByEmailResponse.student:type_name -> course_recommender.Student
	13, // 3: course_recommender.UpdateStudentRequest.student_email:type_name -> google.protobuf.StringValue
	...
	5,  // 9: course_recommender.StudentService.GetStudentByEmail:input_type -> course_recommender.GetStudentByEmailRequest
	...
	6,  // 15: course_recommender.StudentService.GetStudentByEmail:output_type -> course_recommender.GetStudentByEmailResponse
