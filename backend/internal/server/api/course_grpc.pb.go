...
const (
	CourseService_CreateCourse_FullMethodName    = "/course_recommender.CourseService/CreateCourse"
	CourseService_GetCourse_FullMethodName       = "/course_recommender.CourseService/GetCourse"
	CourseService_GetCourseByName_FullMethodName = "/course_recommender.CourseService/GetCourseByName"
	CourseService_UpdateCourse_FullMethodName    = "/course_recommender.CourseService/UpdateCourse"
	CourseService_ListCourses_FullMethodName     = "/course_recommender.CourseService/ListCourses"
	CourseService_DeleteCourse_FullMethodName    = "/course_recommender.CourseService/DeleteCourse"
)
...
func (c *courseServiceClient) GetCourseByName(ctx context.Context, in *GetCourseByNameRequest, opts ...grpc.CallOption) (*GetCourseByNameResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(GetCourseByNameResponse)
	err := c.cc.Invoke(ctx, CourseService_GetCourseByName_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (UnimplementedCourseServiceServer) GetCourseByName(context.Context, *GetCourseByNameRequest) (*GetCourseByNameResponse, error) {
...
func _CourseService_GetCourseByName_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(GetCourseByNameRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(CourseServiceServer).GetCourseByName(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: CourseService_GetCourseByName_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(CourseServiceServer).GetCourseByName(ctx, req.(*GetCourseByNameRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var CourseService_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "course_recommender.CourseService",
	...
	Methods: []grpc.MethodDesc{
		...
		},
		{
			...
			Handler:    _CourseService_GetCourseByName_Handler,
		},
		{
