...
const (
	StudentService_CreateStudent_FullMethodName        = "/course_recommender.StudentService/CreateStudent"
	StudentService_GetStudent_FullMethodName           = "/course_recommender.StudentService/GetStudent"
	StudentService_GetStudentByUsername_FullMethodName = "/course_recommender.StudentService/GetStudentByUsername"
	StudentService_UpdateStudent_FullMethodName        = "/course_recommender.StudentService/UpdateStudent"
	StudentService_ListStudents_FullMethodName         = "/course_recommender.StudentService/ListStudents"
	StudentService_DeleteStudent_FullMethodName        = "/course_recommender.StudentService/DeleteStudent"
)
...
func (c *studentServiceClient) GetStudentByUsername(ctx context.Context, in *GetStudentByUsernameRequest, opts ...grpc.CallOption) (*GetStudentByUsernameResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(GetStudentByUsernameResponse)
	err := c.cc.Invoke(ctx, StudentService_GetStudentByUsername_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (UnimplementedStudentServiceServer) GetStudentByUsername(context.Context, *GetStudentByUsernameRequest) (*GetStudentByUsernameResponse, error) {
...
func _StudentService_GetStudentByUsername_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(GetStudentByUsernameRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(StudentServiceServer).GetStudentByUsername(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: StudentService_GetStudentByUsername_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(StudentServiceServer).GetStudentByUsername(ctx, req.(*GetStudentByUsernameRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var StudentService_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "course_recommender.StudentService",
	...
	Methods: []grpc.MethodDesc{
		...
		},
		{
			...
			Handler:    _StudentService_GetStudentByUsername_Handler,
		},
		{
